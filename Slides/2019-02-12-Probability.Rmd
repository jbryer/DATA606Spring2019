...
* What are the minimum computer requirements for doing data science?
* For those in NYC, join the [New York Open Statistical Programming Meetup](https://www.meetup.com/nyhackr/) group. They announced this year's [NYC R Coference](https://www.rstats.nyc/) will be May 10th and 11th (https://www.rstats.nyc/). If you join the Meetup group, there is a discount code.
...
* Omar Pineda (1.23) http://rpubs.com/omarp120/464956
* John Perez (1.69)
